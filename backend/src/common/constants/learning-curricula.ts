...
export const QAIDAH_LESSONS: CurriculumTopic[] = [
  ...
  { id: 'qaidah-2', order: 2, nameEn: 'Huruf Al-Hijaa Al-Murakkabah', nameAr: 'حروف الهجاء المركبة' },
  ...
  { id: 'qaidah-6', order: 6, nameEn: 'Exercises on Harakat and Tanween', nameAr: 'تدريبات على الحركات والتنوين' },
  { id: 'qaidah-7', order: 7, nameEn: 'Small Alif, Small Ya, and Small Waw', nameAr: 'الألف الصغيرة والياء الصغيرة والواو الصغيرة' },
  { id: 'qaidah-8', order: 8, nameEn: 'Huruf Al-Madd wal-Leen', nameAr: 'حروف المد واللين' },
  { id: 'qaidah-9', order: 9, nameEn: 'Exercises on Tanween, Madd and Leen', nameAr: 'تدريبات على التنوين والمد واللين' },
  ...
  { id: 'qaidah-14', order: 14, nameEn: 'Exercises on Shaddah and Sukoon', nameAr: 'تدريبات على الشدة والسكون' },
  { id: 'qaidah-15', order: 15, nameEn: 'Exercises on Double Shaddah in Words', nameAr: 'تدريبات على الشدتين في كلمة' },
  { id: 'qaidah-16', order: 16, nameEn: 'Exercises on Shaddah, Sukoon and Madd', nameAr: 'تدريبات على الشدة والسكون مع المد' },
  { id: 'qaidah-17', order: 17, nameEn: 'Comprehensive Review Exercises', nameAr: 'تدريبات على ما سبق' },
];

export const TAJWEED_TOPICS: CurriculumTopic[] = [
  { id: 'tajweed-1', order: 1, nameEn: 'Noon Sakinah Rules', nameAr: 'أحكام النون الساكنة والتنوين' },
