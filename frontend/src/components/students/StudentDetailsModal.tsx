...
export function StudentDetailsModal({ open, onClose, student }: StudentDetailsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto rounded-[3rem] p-0 border-none shadow-2xl dark:bg-gray-900 overflow-hidden">
        ...
        <div className="relative h-60 bg-gradient-to-br from-[#084133] via-[#0a5c48] to-[#107c62]">
          ...
          <div className="absolute -bottom-12 left-8 flex items-end gap-6 z-20">
            <div className="w-36 h-36 rounded-[2.5rem] border-[8px] border-white dark:border-gray-900 bg-white dark:bg-gray-800 shadow-2xl overflow-hidden flex-shrink-0">
              {student.avatarUrl ? (
                <img src={student.avatarUrl} alt={student.fullName} className="w-full h-full object-cover" />
              ) : (
                <div className="w-full h-full flex items-center justify-center bg-gray-50 dark:bg-gray-700 text-[#084133] text-5xl font-black">
            ...
            <div className="pb-14">
              ...
              <div className="flex items-center gap-2 mt-3">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/30 backdrop-blur-md text-emerald-300 text-[10px] font-bold border border-white/10">
          ...
          <div className="absolute top-6 right-8">
            <Badge className={cn(
              ...
              student.status === 'active' ? "bg-emerald-400 text-emerald-950" : "bg-gray-400 text-white"
            )}>
              {student.status}
            </Badge>
          </div>
        ...
        <div className="pt-28 px-8 pb-10 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-emerald-50/50 dark:bg-emerald-900/10 p-5 rounded-3xl border border-emerald-100 dark:border-emerald-900/30">
              ...
              <h3 className="text-2xl font-black text-emerald-900 dark:text-emerald-400">{student.attendanceRate || 0}%</h3>
              <div className="w-full h-1.5 bg-emerald-100 dark:bg-emerald-900/40 rounded-full mt-2 overflow-hidden">
                <div className="h-full bg-emerald-600 rounded-full" style={{ width: `${student.attendanceRate}%` }} />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-3xl p-6 border border-gray-100 dark:border-gray-800 space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-gray-900 dark:text-gray-200">{student.email}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-xl bg-white dark:bg-gray-800 flex items-center justify-center shadow-sm">
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Current Residency</p>
              ...
              <div>
                ...
                <div className="bg-[#084133]/5 dark:bg-[#084133]/10 rounded-3xl p-6 border border-[#084133]/10 dark:border-emerald-900/30 flex items-center justify-between">
                   ...
                   {student.teacher && (
                     <Button variant="ghost" size="sm" className="rounded-xl font-bold bg-white/50 dark:bg-gray-800">
                        Profile
                     </Button>
                   )}
                </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge variant="outline" className="rounded-lg text-[10px] font-black uppercase px-2 py-0.5 border-emerald-900/20 text-[#084133]">
              ...
              <div className="space-y-3">
                {student.schedules && student.schedules.length > 0 ? (
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800/50 p-8 rounded-3xl border border-dashed border-gray-200 dark:border-gray-700 text-center">
                     <Calendar className="h-10 w-10 text-gray-300 mx-auto mb-2" />
                     <p className="text-xs font-bold text-gray-400 tracking-tight italic">No classes scheduled yet.</p>
                  </div>
                )}
              </div>
            </div>
