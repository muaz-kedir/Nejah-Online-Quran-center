...
let EmailService = EmailService_1 = class EmailService {
    ...
    async sendApplicationReceived(to, applicantName, applicationNumber) {
    ...
    async sendApplicationApproved(to, applicantName, loginEmail, temporaryPassword) {
        const html = this.wrap(`
    ...
    async sendApplicationRejected(to, applicantName, reason) {
        const html = this.wrap(`
    ...
    async sendMoreInfoRequired(to, applicantName, message) {
        const html = this.wrap(`
