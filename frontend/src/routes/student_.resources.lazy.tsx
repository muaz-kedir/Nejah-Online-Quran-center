  ...
  return (
    <StudentPortalLayout activePath={studentPaths.resources}>
      <main className="flex-1 px-4 sm:px-6 lg:px-10 py-6 lg:py-10 max-w-7xl mx-auto">
        ...
        {/* Featured */}
        {Array.isArray(featured) && featured.length > 0 && !search && selectedCategory === 'All' && selectedType === 'All' && (
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-2">
              <Star className="w-6 h-6 text-amber-500" /> Featured Materials
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Array.isArray(featured) && featured.map((r) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-card rounded-[32px] p-6 border shadow-sm">
              ...
              {Array.isArray(downloadHistory) && downloadHistory.length > 0 ? (
                <div className="space-y-3">
                  {Array.isArray(downloadHistory) && downloadHistory.slice(0, 5).map((d) => (
