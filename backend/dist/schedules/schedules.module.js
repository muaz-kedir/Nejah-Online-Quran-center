...
exports.SchedulesModule = SchedulesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([schedule_entity_1.Schedule, schedule_student_entity_1.ScheduleStudent, student_entity_1.Student, teacher_entity_1.Teacher]),
            teachers_module_1.TeachersModule,
            (0, common_1.forwardRef)(() => zoom_module_1.ZoomModule),
        ],
