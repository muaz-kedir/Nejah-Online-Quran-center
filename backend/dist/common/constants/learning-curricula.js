...
exports.TAJWEED_TOPICS = exports.QAIDAH_LESSONS = void 0;
exports.resolveLearningTrack = resolveLearningTrack;
exports.getTopicsForTrack = getTopicsForTrack;
exports.getTopicById = getTopicById;
exports.getNextTopic = getNextTopic;
exports.formatTopicLabel = formatTopicLabel;
exports.getTrackLabel = getTrackLabel;
const student_entity_1 = require("../../students/entities/student.entity");
exports.QAIDAH_LESSONS = [
...
function resolveLearningTrack(level) {
    switch (level) {
        case student_entity_1.QuranLevel.QAIDA_NOORANIYA:
            return 'qaidah';
        case student_entity_1.QuranLevel.TAJWEED_PROGRAM:
            return 'tajweed';
        case student_entity_1.QuranLevel.HIFZ_PROGRAM:
        case student_entity_1.QuranLevel.HIFZ_MURAJAA:
            return 'hifz';
        case student_entity_1.QuranLevel.QURAN_READING:
        default:
...
function getTopicsForTrack(track) {
    switch (track) {
        case 'qaidah':
            return exports.QAIDAH_LESSONS;
        case 'tajweed':
            return exports.TAJWEED_TOPICS;
        default:
            return [];
    }
}
function getTopicById(track, topicId) {
    return getTopicsForTrack(track).find((t) => t.id === topicId);
}
function getNextTopic(track, completedIds) {
...
//# sourceMappingURL=learning-curricula.js.map